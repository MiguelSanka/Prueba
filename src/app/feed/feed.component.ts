...
export class FeedComponent implements OnInit {
  ...
  like(id: number){
    if((document.getElementById(id.toString()) as HTMLIonIconElement).color != "danger")
    {
      (document.getElementById(id.toString()) as HTMLIonIconElement).color="danger",
      (document.getElementById(id.toString()) as HTMLIonIconElement).icon = "heart"
    }
    else
    {
      (document.getElementById(id.toString()) as HTMLIonIconElement).color = "white",
      (document.getElementById(id.toString()) as HTMLIonIconElement).icon = "heart-outline"
    }
  }
